...
TEXT_STYLES: dict[str, TextStyle] = {
    ...
    "sticker_script": TextStyle(font_size=100, primary="#7CF0B0", outline="#0B3D2A", outline_w=5, bold=False,
    ...
    "label_script": TextStyle(font_size=120, primary="#FFFFFF", outline="#000000", outline_w=6, bold=False,
                              font="Marck Script"),
    # Стили субтитров
